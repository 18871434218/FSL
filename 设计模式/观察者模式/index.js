var ConcreteSubject = /** @class */ (function () {
    ...
    ConcreteSubject.prototype.detach = function (observer) {
        ...
        if (observerIndex === -1) {
            return console.log('Subject: Noneistent observer.');
        }
    ...
    ConcreteSubject.prototype.someBusinessLogic = function () {
        console.log('\n Subject: I\'m doing something importing.');
        this.state = Math.floor(Math.random() * (10 + 1));
        console.log("Subject: My state has just change to: " + this.state);
        this.notify();
    };
...
var ConcreteObserverB = /** @class */ (function () {
    ...
    ConcreteObserverB.prototype.update = function (subject) {
        if (subject instanceof ConcreteSubject && (subject.state === 0 || subject.state)) {
